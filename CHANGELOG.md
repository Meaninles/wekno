...
- **FIXED**: Chat — model fallback now includes history; pipeline tabular SQL stage no longer runs for agents that did not opt in.
...
### 🚀 New Features
- **NEW**: Data Analysis Agent & Tools
  - Added built-in Data Analysis agent
