...
from app.models import ProviderStreamInterrupted
...
@pytest.mark.parametrize("error,expected", [
    ...
    (httpx.RemoteProtocolError("private transport detail"), "connection"),
    (ProviderStreamInterrupted("incomplete stream"), "connection"),
