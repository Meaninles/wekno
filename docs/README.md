...
总入口；生产版本、资源、模型和发布约束以
[当前生产实现与部署基线](./custom/当前生产实现与部署基线.md)为第一权威说明。

## 按角色阅读

| 角色 | 首要文档 | 后续文档 |
|---|---|---|
| 生产运维 | [当前生产实现与部署基线](./custom/当前生产实现与部署基线.md) | [生产执行手册](./custom/当前版本生产更新部署执行手册.md)、[生产无 RWX 方案](./custom/生产集群无RWX最优部署方案.md)、[Helm](../helm/README.md) |
