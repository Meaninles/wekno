...
| DeepSeek V4 Flash 容量 | [20260726-deepseek-v4-flash](../../custom/tests/model_capacity_reports/20260726-deepseek-v4-flash.json) | 32 个并发、每请求实际生成 160 token，32/32 成功，P95 5.655 秒；生产集群准入取 24 |
