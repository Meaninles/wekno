...
> 多副本。总体架构以[当前实现架构与文档索引](../custom/当前实现架构与文档索引.md)
> 为准；生产更新使用[生产执行手册](../custom/当前版本生产更新部署执行手册.md)。
...
| [智能体技能系统](核心功能/Agent技能系统.md) | 智能体技能扩展机制与预加载技能 |
...
| [当前实现架构](../custom/当前实现架构与文档索引.md) | 文档队列、Agent、存储、生产拓扑与文档索引 |
| [生产部署执行手册](../custom/当前版本生产更新部署执行手册.md) | 现有生产的迁移、部署、验收与回滚 |
