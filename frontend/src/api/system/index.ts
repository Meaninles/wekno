 ...
 * username (the human-friendly path used by the SystemAdmin UI). Backend
...
export interface PromoteUserToSystemAdminRequest {
  /** UUID of the user to promote. Optional; supply this OR `username`. */
  user_id?: string
  /** Username of the user to promote. Optional; supply this OR `user_id`. */
  username?: string
}
...
export interface SystemSettingItem {
   ...
   * username when known. Empty/undefined for
