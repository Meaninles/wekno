export default {
    ...
    kbCreate: {
      steps: {
        ...
        indexing: {
          ...
          desc: 'The default RAG search suits most Q&A scenarios. Advanced indexing is usually unnecessary; keep at least one search mode enabled.',
        },
        navModels: {
  ...
  knowledgeFolders: {
    ...
    taskOverview: 'Current task overview',
		taskOverviewLoadFailed: 'Could not load. Click to retry',
    parsePending: 'Pending parsing',
    parseRunning: 'Parsing',
    derivativeTasks: 'Derivative tasks',
    abnormalDocuments: 'Abnormal documents',
    ...
    moveSuccess: 'Folder moved',
		...
		deleteFailed: 'Folder deletion failed',
		deleteNonEmpty: 'Delete "{name}" and all documents and subfolders inside it? This cannot be undone.',
		deleteEmpty: 'Delete the empty folder "{name}"?',
		deleteAll: 'Delete all contents',
    moveDocumentHere: 'Move to another folder',
    searchPlaceholder: 'Search folders and documents in this folder',
  },
  knowledgeBase: {
    ...
    previousChunkPage: 'Previous',
    nextChunkPage: 'Next',
    chunkPageStatus: 'Page {page}/{pages} · fetched {loaded}/{total}',
    ...
    filterNoResults: 'No documents match the current filters',
    filterNoResultsHint: 'The documents are still in this knowledge base. Adjust or clear the filters.',
    clearDocumentFilters: 'Clear filters',
    pdfDocFormat: 'All supported document formats are split automatically when needed',
    textMarkdownFormat: 'Up to 2 GB per logical document (deployment-configurable)',
    ...
    uploadInfoTitle: 'Upload Info',
    uploadInfoStartedAt: 'Started at',
    uploadInfoElapsed: 'Elapsed',
    uploadInfoTotal: '{count} total',
    uploadInfoSuccess: '{count} succeeded',
    uploadInfoFailed: '{count} failed',
    uploadInfoEmpty: 'No upload records',
    uploadInfoBatchTitle: 'Upload task ({count} items)',
    uploadInfoBatchRunning: '{done}/{total} processed',
    uploadInfoBatchSuccess: 'All succeeded ({total})',
    uploadInfoBatchFailed: 'All failed ({total})',
    uploadInfoBatchPartial: '{success} succeeded, {failed} failed',
    uploadInfoRunning: '{count} item(s) uploading or processing',
    uploadInfoQueued: '{count} item(s) queued',
    uploadInfoWaiting: 'Waiting to start',
    uploadInfoClearFinished: 'Clear completed',
    uploadInfoClearCompleted: 'Clear completed',
    uploadInfoClearAll: 'Clear all',
    uploadInfoStatusQueued: 'Queued',
    uploadInfoStatusUploading: 'Uploading',
    uploadInfoStatusProcessing: 'Processing',
    uploadInfoStatusSuccess: 'Submitted',
    uploadInfoStatusFailed: 'Failed',
    uploadInfoSubmittedForParsing: 'Submitted for parsing',
    uploadInfoFetchingUrl: 'Importing URL',
  ...
  knowledgeWorkflowStatus: {
    ...
    status: {
      ...
      draft: 'Draft',
      unknown: 'Unknown',
      not_started: 'Waiting for prerequisite',
      disabled: 'Not enabled',
      not_applicable: 'Not applicable',
      skipped: 'No work required',
  ...
  agent: {
    ...
    retrievedDocuments: 'Searched <strong>{count}</strong> document(s)',
    retrievedDataSources: 'Searched <strong>{count}</strong> data source(s)',
    noRetrievedDocuments: 'No documents searched',
    noRetrievedDataSources: 'No data sources searched',
    ...
    shareScope: {
      ...
      kbNone: 'None',
      dataSourceSelected: '{count} selected',
      dataSourceNone: 'None',
    ...
    editor: {
      ...
      nativeAgentWebSearch: 'General agent native search',
  ...
  inviteRegister: {
    ...
    emailHint: 'Use your username to register.',
    emailInvalid: 'Enter username',
    username: 'Username',
  ...
  auth: {
    ...
    emailPlaceholder: 'Enter username',
    passwordPlaceholder: 'Enter password (8-32 chars, at least two of letters/numbers/symbols)',
    ...
    passwordRuleHint: 'Password rule: 8-32 characters, use at least two of letters, numbers, and symbols, no spaces.',
    passwordNoWhitespace: 'Password cannot contain spaces',
    passwordMustUseTwoTypes: 'Password must use at least two of letters, numbers, and symbols',
    ...
    loginError: 'Login error, please check username or password',
  ...
  input: {
    ...
    placeholderWithSkill: 'Enter your question, will answer with the selected Skill context',
    ...
    agentMissingDatabaseSources: 'Data sources',
    ...
    notConfigured: 'Not configured',
    agentModelLabel: 'Model from agent',
    ...
    messages: {
      ...
      fileInfoLoading: 'The selected file information is still loading. Please try again shortly.',
  ...
  skill: {
    title: 'Skills',
    subtitle: 'Manage reusable lightweight constraints and workflows for agents or direct chat context.',
    create: 'New Skill',
    noDescription: 'No description',
    enabled: 'Enabled',
    disabled: 'Disabled',
    deleteConfirm: 'Delete Skill "{name}"? This action cannot be undone.',
    origin: {
      mine: 'Mine',
      space: 'Shared space',
      userShared: 'Shared by coworker',
    },
    empty: {
      title: 'No Skills yet',
      desc: 'Create a Skill to capture recurring workflows, tone, or output formats.',
    },
    selector: {
      searchPlaceholder: 'Search Skills',
      professionalTab: 'Professional',
      lightweightTab: 'Lightweight',
      empty: 'No Skills available',
      professionalEmpty: 'No professional Skills available',
      noMatch: 'No matching Skills',
      sandboxUnavailable: 'Skills are not enabled in this environment',
      professionalUnavailable: 'Professional Skills are not enabled in this environment',
      manage: 'Manage',
    },
    editor: {
      ...
      enabled: 'Enabled',
      skillMd: 'SKILL.md',
      templateTip: 'Follow the preloaded SKILL.md format: put name and description in YAML frontmatter, then describe usage, workflow, and output requirements in Markdown.',
      readOnlyTip: 'This Skill is shared with you. You can view it, but only the owner or an admin can edit and save it.',
      invalidFrontmatter: 'Keep the YAML frontmatter wrapped by ---',
      requiredFields: 'name, description, and body are required',
    },
    share: {
      title: 'Share Skill',
      action: 'Share',
      spaceTab: 'Shared space',
      userTab: 'User',
      sharedSpaces: 'Shared spaces',
      sharedUsers: 'Shared users',
      noUserShares: 'No user shares yet',
      userSearchPlaceholder: 'Search username',
      userShareSuccess: 'Shared with user',
      userShareFailed: 'Failed to share with user',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeFAQ: 'FAQ Q&A',
      typeDescription: 'FAQ suits structured Q&A datasets; document type supports file parsing, chunking and retrieval.',
    ...
    indexing: {
      ...
      description: 'RAG search suits most Q&A scenarios. Expand advanced options only when a higher-cost index is needed.',
      searchTitle: 'RAG Search',
      searchDesc: 'Chunk, vectorize and keyword-index documents for hybrid retrieval',
      recommended: 'Recommended',
      advancedTitle: 'Advanced indexing',
      advancedDesc: 'Uses additional model calls and is usually unnecessary',
      advancedEnabledSummary: 'Wiki enabled · {granularity}',
      wikiTitle: 'Wiki Knowledge Base',
      wikiDesc: 'Auto-generate interlinked wiki pages to build a structured knowledge system',
      wikiCostDesc: 'Wiki uses model calls to generate and maintain linked pages, so processing cost grows with document volume. Enable it only for directory-style reading or cross-document organization; use RAG for ordinary Q&A.',
      wikiUnavailable: 'Wiki is temporarily unavailable. Contact an administrator to enable Wiki access.',
    ...
    wikiBrowser: {
      ...
      graphNodeCatalogue: 'Node categories',
      graphSearchNodes: 'Search all nodes',
      graphNoMatchingNodes: 'No matching nodes',
      graphSelectNodeHint: 'Select a node from the categorized list',
      graphBackCenter: 'Previous node',
      graphViewDetails: 'View details',
      graphSetAsCenter: 'Set as center',
      graphNeighborProgress: '{returned} on this page / {total} related nodes',
      graphHelpListAction: 'Select list node',
      graphHelpListDesc: 'Show its one-hop neighborhood',
      graphHelpNeighborAction: 'Click related node',
      graphHelpNeighborDesc: 'Pivot the graph to that node',
      graphHelpCenterAction: 'Click center node',
      graphHelpCenterDesc: 'Open node details',
...
\
  ...
  chat: {
    ...
    citedReferences: 'Cited {count} reference(s)',
    noCitedReferences: 'No references cited',
  ...
  tenant: {
    ...
    api: {
      ...
      usernameDescription: 'Your username',
      emailLabel: 'Username',
      emailDescription: 'Your username',
  ...
  system: {
    ...
    globalSettings: {
      ...
      admins: {
        ...
        description: 'Users with platform-level privileges. Type a username and press Enter to promote a user; click × on a tag to revoke. You (yourself) are an administrator and are not shown in the list — you cannot revoke your own access.',
        ...
        confirm: {
          promote: {
            ...
            body: 'Promote {username} to system administrator? This user will gain platform-level privileges: access to every tenant, system settings, and the admin roster itself.',
            confirmBtn: 'Promote',
          },
          revoke: {
            header: 'Revoke system administrator',
            body: 'Revoke system-administrator privileges from {username}? They will lose access to all system-level features.',
            confirmBtn: 'Revoke',
          },
        },
      },
  ...
  organization: {
    ...
    addMember: {
      ...
      modeTenant: 'By Workspace',
      modeMember: 'By Member',
      modeOrganization: 'By Organization',
      ...
      tipMember: 'Select IAM-synced members directly. Members who have not logged in yet are granted pending access and will join after first login.',
      tipOrganization: 'Select organizations from the IAM tree. Child nodes are loaded on expand; selected organizations add their direct members only.',
      ...
      memberSearchPlaceholder: 'Search member name or account, or leave blank',
      ...
      memberSelectHint: 'The list shows available members by default; type to filter it',
      organizationTreeHint: 'The organization tree is collapsed by default. Expanding loads the next level; selecting an organization adds its direct members only.',
      organizationSelectedHint: '{orgCount} organization nodes selected; {memberCount} workspace members will be added',
      organizationUserCount: '{count} people',
      organizationPreview: '{count} workspace members will be added',
      noCandidates: 'No available members',
      noOrganizations: 'No IAM organizations',
      noOrganizationName: 'No organization',
      pendingLoginTenant: 'Pending first login',
      duplicateTenantHint: '{count} duplicate members from the same workspace were merged',
      selectRole: 'Assign Role',
      confirmBtn: 'Add',
      confirmBatchBtn: 'Add {count} Members',
      success: 'Member added successfully',
      batchSuccess: '{count} members added',
      batchFailed: '{count} members failed to add',
  ...
  preview: {
    ...
    safePreviewTitle: 'Safe preview enabled',
    safePreviewHint: 'This document is large or structurally complex, so the original file will not be loaded into browser memory at once. Use paged parsed content to avoid UI freezes or out-of-memory errors.',
    viewPagedContent: 'View paged parsed content',
    truncatedHint: 'To keep the page responsive, the original-file preview shows only the first 512 KB. Use the chunk view for the complete paged content.',
    audioSafePreviewHint: 'This audio file is too large for an in-memory browser preview, so full-file loading was stopped.',
  },
  commandPalette: {
  ...
  agentStream: {
    ...
    tools: {
      ...
      tableAnalysisDisplayIntent: 'Chart Intent',
      databaseQuery: 'Database Query',
      dbCatalog: 'Database Catalog',
      dbSchema: 'Database Schema',
      dbQuery: 'Database Analysis',
    },
    summary: {
    ...
    ragPipeline: {
      ...
      retrievalSummary: 'Search complete, searched {count} document(s), took {duration}',
      dataSourceRetrievalSummary: 'Search complete, searched {count} data source(s), took {duration}',
      noRetrievalSummary: 'Search complete, no documents searched, took {duration}',
      noDataSourceRetrievalSummary: 'Search complete, no data sources searched, took {duration}',
  ...
  agentEditor: {
    ...
    dataAnalysis: {
      enableLabel: 'Enable Data Analysis',
  ...
  tenantMember: {
    ...
    errors: {
      ...
      userNotFound: 'No registered user with this username. Ask them to sign up first.',
  ...
  tenantInvitation: {
    ...
    confirmInviteBody:
      'Send an invitation to {username} (role: {role}). They will join the tenant only after accepting.',
    confirmSend: 'Send',
    ...
    shareLink: {
      ...
      description:
        "Generate a multi-use registration link you can drop in a group chat. Anyone who opens it registers with their own username and joins this workspace. Expires in {days} days, or revoke it any time from the list.",
    ...
    revoke: {
      ...
      confirmBody:
        "After revoke, {username} can no longer accept this invitation. You can send a new one if needed.",
      confirm: 'Revoke',
