...
\
  ...
  tenant: {
    ...
    api: {
      ...
      emailLabel: 'Username',
      emailDescription: 'Your login username',
  ...
  organization: {
    ...
    addMember: {
      ...
      tipMember: 'Select multiple IAM-synced members directly. They will be added by their mapped workspace; duplicate workspaces are merged.',
      tipOrganization: 'Select organizations from the IAM organization tree. Any level can be selected; selected parent nodes include descendants.',
      ...
      organizationTreeHint: 'The organization tree is collapsed by default. Selecting any level includes its child organizations.',
