export default {
  ...
  knowledgeBase: {
    ...
    filterNoResults: "현재 필터와 일치하는 문서가 없습니다",
    filterNoResultsHint: "문서는 지식베이스에 그대로 있습니다. 필터를 조정하거나 지우세요.",
    clearDocumentFilters: "필터 지우기",
    pdfDocFormat: "지원되는 모든 문서 형식은 필요할 때 자동으로 분할됩니다",
    textMarkdownFormat: "논리 문서당 최대 2GB(배포 설정에 따라 변경 가능)",
  ...
  knowledgeStages: {
    ...
    root: "지식 처리",
    attempt: "처리 실행 {n}",
    attemptLatest: "처리 실행 {n} (최신)",
    attemptHelp: "업로드 또는 수동 재분석 시 새 처리 실행이 생성되며, 작업 내부의 자동 재시도는 같은 실행에 유지됩니다.",
    retry: "다시 파싱",
    refresh: "지금 새로고침",
    copy: "복사",
    copyDetails: "세부정보 복사",
  ...
  auth: {
    ...
    passwordPlaceholder: "비밀번호 입력 (8-32자, 문자/숫자/기호 중 2종 이상)",
    ...
    passwordRuleHint: "비밀번호 규칙: 8-32자, 문자/숫자/기호 중 2종 이상, 공백 없음.",
    passwordNoWhitespace: "비밀번호에는 공백을 포함할 수 없습니다",
    passwordMustUseTwoTypes: "비밀번호는 문자, 숫자, 기호 중 2종 이상을 포함해야 합니다",
  ...
  agent: {
    ...
    shareScope: {
      ...
      kbNone: "사용되지 않음",
      dataSourceSelected: "{count} 데이터 소스 지정",
      dataSourceNone: "사용되지 않음",
      modelConfigured: "구성된",
      modelNotSet: "구성되지 않음",
      enabled: "켜다",
      disabled: "비활성화",
    ...
    editor: {
      ...
      nativeAgentWebSearch: "범용 에이전트 기본 검색",
  ...
  knowledgeEditor: {
    ...
    indexing: {
      ...
      wikiUnavailable: "Wiki 기능을 현재 사용할 수 없습니다. 관리자에게 Wiki 권한 활성화를 요청하세요.",
      graphTitle: "지식 그래프",
    ...
    wikiBrowser: {
      ...
      graphNodeCatalogue: '노드 분류',
      graphSearchNodes: '모든 노드 검색',
      graphNoMatchingNodes: '일치하는 노드가 없습니다',
      graphSelectNodeHint: '왼쪽 분류 목록에서 노드를 선택하세요',
      graphBackCenter: '이전 노드',
      graphViewDetails: '상세 보기',
      graphSetAsCenter: '중심으로 설정',
      graphNeighborProgress: '현재 페이지 {returned} / 관련 노드 {total}개',
      graphHelpListAction: '목록 노드 선택',
      graphHelpListDesc: '해당 노드의 1단계 관계 표시',
      graphHelpNeighborAction: '관련 노드 클릭',
      graphHelpNeighborDesc: '해당 노드를 중심으로 전환',
      graphHelpCenterAction: '중심 노드 클릭',
      graphHelpCenterDesc: '노드 상세 보기',
      showArrows: '화살표 표시',
      hideArrows: '화살표 숨기기',
  ...
  input: {
    ...
    placeholderWithSkill: "질문을 입력하면 선택한 Skill 컨텍스트를 반영해 답변합니다",
    ...
    agentMissingDatabaseSources: "데이터베이스 데이터 소스",
    ...
    messages: {
      ...
      fileInfoLoading: "선택한 파일 정보를 불러오는 중입니다. 잠시 후 다시 시도해주세요.",
  ...
  skill: {
    title: "Skills",
    subtitle: "에이전트나 직접 대화 컨텍스트에 사용할 재사용 가능한 가벼운 제약과 워크플로를 관리합니다.",
    create: "새 Skill",
    noDescription: "설명 없음",
    enabled: "활성화",
    disabled: "비활성화",
    deleteConfirm: 'Skill "{name}"을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
    origin: {
      mine: "내 Skill",
      space: "공유 스페이스",
      userShared: "동료 공유",
    ...
    empty: {
      title: "아직 Skill이 없습니다",
      desc: "반복되는 절차, 톤, 출력 형식을 Skill로 저장하세요.",
    },
    selector: {
    ...
    editor: {
      ...
      enabled: "활성화",
      skillMd: "SKILL.md",
      templateTip: "사전 정의된 SKILL.md 형식을 따르세요. YAML frontmatter에는 name과 description을 쓰고, 본문에는 사용 장면, 절차, 출력 요구를 Markdown으로 작성합니다.",
      readOnlyTip: "공유받은 Skill입니다. 내용을 볼 수 있지만 소유자 또는 관리자만 편집하고 저장할 수 있습니다.",
      invalidFrontmatter: "--- 로 감싼 YAML frontmatter를 유지하세요",
      requiredFields: "name, description, 본문은 필수입니다",
    },
    share: {
      title: "Skill 공유",
      action: "공유",
      spaceTab: "공유 스페이스",
      userTab: "사용자",
      sharedSpaces: "공유된 스페이스",
      sharedUsers: "공유된 사용자",
      noUserShares: "사용자 공유 없음",
      userSearchPlaceholder: "사용자 이름 검색",
      userShareSuccess: "사용자에게 공유했습니다",
      userShareFailed: "사용자 공유 실패",
      loadFailed: "공유 목록 로드 실패",
      searchUserFailed: "사용자 검색 실패",
    },
    messages: {
      loadFailed: "Skill 로드 실패",
      created: "Skill이 생성되었습니다",
      updated: "Skill이 업데이트되었습니다",
      deleted: "Skill이 삭제되었습니다",
      saveFailed: "Skill 저장 실패",
    },
  },
  agentSettings: {
    title: "Agent 설정",
  ...
  organization: {
    ...
    addMember: {
      ...
      success: "회원이 추가되었습니다.",
      failed: "추가 실패",
      pendingLoginTenant: "첫 로그인 후 가입 대기",
      roleHint: {
        viewer: "보기 및 검색 가능",
        editor: "편집 가능한 콘텐츠",
        admin: "전체 관리 권한",
  ...
  preview: {
    ...
    safePreviewTitle: '안전 미리보기 사용',
    safePreviewHint: '문서가 크거나 내부 구조가 복잡하여 원본 파일을 브라우저 메모리에 한 번에 로드하지 않습니다. 멈춤이나 메모리 부족을 방지하려면 페이지 단위 파싱 내용을 확인하세요.',
    viewPagedContent: '페이지 단위 파싱 내용 보기',
    truncatedHint: '페이지 응답성을 위해 원본 미리보기는 처음 512KB만 표시합니다. 전체 내용은 청크 보기에서 확인하세요.',
    audioSafePreviewHint: '오디오 파일이 너무 커서 브라우저 메모리 보호를 위해 전체 파일 로드를 중지했습니다.',
  },
  commandPalette: {
  ...
  agentStream: {
    ...
    tools: {
      ...
      tableAnalysis: '표 분석',
      tableSchema: '표 구조',
      tableAnalysisDisplayIntent: '차트 의도 판단',
      databaseQuery: '데이터베이스 조회',
      dbCatalog: '데이터베이스 카탈로그',
      dbSchema: '데이터베이스 구조',
      dbQuery: '데이터베이스 분석',
    },
    summary: {
