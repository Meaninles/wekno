...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    desc: {
      ...
      nativeAgentWebSearch: 'Только для универсального агента. Если включено, универсальный агент получает встроенные WebSearch/WebFetch; если выключено, эти инструменты не включаются.',
