export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，智汇会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  contextualGuide: {
    ...
    kbCreate: {
      steps: {
        ...
        indexing: {
          title: "选择索引能力",
          desc: "默认的 RAG 检索适合大多数问答场景。其他高级索引能力通常无需开启，至少保留一种检索方式。",
        },
        navModels: {
          title: "配置模型（必填）",
  ...
  knowledgeFolders: {
    ...
    taskOverview: "当前任务概况",
		taskOverviewLoadFailed: "加载失败，点击重试",
    parsePending: "待解析文档",
    parseRunning: "解析中文档",
    derivativeTasks: "衍生任务",
    abnormalDocuments: "异常文档",
    ...
    moveSuccess: "文件夹已移动",
		...
		deleteNonEmpty: "确定删除“{name}”及其中的全部文档和子文件夹吗？此操作不可撤销。",
		deleteEmpty: "确定删除空文件夹“{name}”吗？",
		deleteAll: "删除全部内容",
    moveDocumentHere: "移动到其它文件夹",
    searchPlaceholder: "搜索当前文件夹中的文件夹和文档",
  },
  knowledgeBase: {
    title: "知识库",
    list: "知识库列表",
    ...
    viewChunks: "查看分块",
    viewMerged: "全文",
    previousChunkPage: "上一页",
    nextChunkPage: "下一页",
    chunkPageStatus: "第 {page}/{pages} 页 · 已取回 {loaded}/{total}",
    ...
    filterNoResults: "没有符合当前筛选条件的文档",
    filterNoResultsHint: "文档仍保留在知识库中，可调整或清除筛选条件",
    clearDocumentFilters: "清除筛选",
    pdfDocFormat: "支持全部文档格式，超出单分片限制时自动拆分",
    textMarkdownFormat: "单个逻辑文档最高 2GB（以部署配置为准）",
  ...
  chat: {
    ...
    citedReferences: "已引用 {count} 条参考资料",
    noCitedReferences: "未引用参考资料",
    allReferences: "全部参考资料",
    deepThinking: "深度思考完成",
  ...
  settings: {
    ...
    weknoraCloud: {
      title: "智汇云服务",
      description: "配置智汇云服务的 APPID 和 APPSECRET 凭证。凭证用于模型服务和文档解析引擎。",
      viewDocs: "查看文档",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 zhihui/images",
      prefixPlaceholder: "如 zhihui",
  ...
  auth: {
    ...
    passwordPlaceholder: "输入密码（8-32个字符，字母/数字/符号至少两类）",
    ...
    passwordRuleHint: "密码规则：8-32 个字符；字母、数字、符号至少包含两类；不能包含空格。",
    passwordNoWhitespace: "密码不能包含空格",
    passwordMustUseTwoTypes: "密码必须在字母、数字、符号中至少包含两类",
  ...
  agent: {
    ...
    noToolCalls: "未调用工具",
    retrievedDocuments: "已检索 <strong>{count}</strong> 份文档",
    retrievedDataSources: "已检索 <strong>{count}</strong> 个数据源",
    noRetrievedDocuments: "未检索文档",
    noRetrievedDataSources: "未检索数据源",
    ...
    shareScope: {
      ...
      kbNone: "不使用",
      dataSourceSelected: "指定 {count} 个数据源",
      dataSourceNone: "不使用",
      modelConfigured: "已配置",
      modelNotSet: "未配置",
      enabled: "开启",
    ...
    editor: {
      ...
      nativeAgentWebSearch: "通用智能体原生搜索",
  ...
  tenant: {
    ...
    api: {
      ...
      usernameLabel: "用户名",
      usernameDescription: "您的用户名",
      emailLabel: "用户名",
      emailDescription: "您的用户名",
      createdAtLabel: "注册时间",
  ...
  system: {
    ...
    globalSettings: {
      ...
      admins: {
        label: "系统管理员",
        description: "拥有平台级权限的用户。在右侧输入用户名并回车即可提升用户为管理员；点击 × 即为撤销其权限。当前你（自己）已是管理员，不在列表中显示，也无法被自己撤销。",
        ...
        confirm: {
          promote: {
            header: "提升为系统管理员",
            body: "确认将 {username} 提升为系统管理员？该用户将获得平台级权限，可访问所有租户、修改系统设置、管理其他管理员。",
            confirmBtn: "确认提升",
          },
          revoke: {
            header: "撤销系统管理员",
            body: "确认撤销 {username} 的系统管理员权限？撤销后该用户将无法再访问任何系统级功能。",
            confirmBtn: "确认撤销",
          },
        },
      },
  ...
  model: {
    ...
    editor: {
      ...
      description: {
        chat: "配置用于对话的大语言模型",
        derivative: "配置仅用于 Wiki、图谱、摘要等后台任务的专用模型",
  ...
  embedPublish: {
    ...
    webhookUrlPlaceholder: "https://your-server.example.com/zhihui/embed-events",
    webhookUrlDesc: "可选。访客发消息与助手回复完成时，茅台智汇会向该 HTTPS 地址 POST 事件（message_sent / message_received）。",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeDocument: "文档",
      typeFAQ: "问答",
      typeDescription: "FAQ 类型适合结构化问答数据；文档型支持文件解析、分块和检索。",
      nameLabel: "知识库名称",
    ...
    indexing: {
      title: "索引策略",
      description: "RAG 检索适合大多数问答场景；其他高成本索引能力可按需展开配置",
      searchTitle: "RAG 检索",
      searchDesc: "对文档进行分块、向量化和关键词索引，支持混合检索",
      recommended: "推荐",
      advancedTitle: "高级索引能力",
      advancedDesc: "涉及额外模型调用，通常无需开启",
      advancedEnabledSummary: "Wiki 已开启 · {granularity}",
      wikiTitle: "Wiki 知识库",
      wikiDesc: "自动生成互相关联的 Wiki 知识页面，构建结构化知识体系",
      wikiCostDesc: "Wiki 会调用大模型生成和持续维护互链页面，文档越多处理成本越高。仅在需要目录化阅读和跨文档知识组织时开启；普通问答建议使用 RAG。",
      wikiUnavailable: "Wiki功能暂时无法使用，请联系管理员开放wiki权限",
      graphTitle: "知识图谱",
    ...
    wikiBrowser: {
      ...
      graphNodeCatalogue: '节点分类',
      graphSearchNodes: '搜索全部节点',
      graphNoMatchingNodes: '没有匹配的节点',
      graphSelectNodeHint: '请从左侧分类列表选择一个节点',
      graphBackCenter: '返回上一节点',
      graphViewDetails: '查看详情',
      graphSetAsCenter: '以此为中心',
      graphNeighborProgress: '本页 {returned} / 共 {total} 个关联节点',
      graphHelpListAction: '选择列表节点',
      graphHelpListDesc: '展示该节点的一跳关联图',
      graphHelpNeighborAction: '单击关联节点',
      graphHelpNeighborDesc: '切换为该节点的关联图',
      graphHelpCenterAction: '单击中心节点',
      graphHelpCenterDesc: '打开节点详情',
      showArrows: '显示箭头',
      hideArrows: '隐藏箭头',
  ...
  input: {
    ...
    placeholderWithSkill: "输入问题，将按上方选中的 Skill 约束回答",
    ...
    agentMissingDatabaseSources: "数据源",
  ...
  skill: {
    title: "技能",
    subtitle: "管理可复用的轻量约束和工作流程，可用于智能体或直接挂到对话上下文。",
    create: "新建 Skill",
    noDescription: "暂无描述",
    enabled: "启用",
    disabled: "停用",
    deleteConfirm: "确定要删除 Skill「{name}」吗？此操作无法撤销。",
    origin: {
      mine: "我的",
      space: "共享空间",
      userShared: "同事共享",
    ...
    empty: {
      title: "暂无 Skill",
      desc: "创建一个 Skill，把常用流程、口径或输出格式沉淀下来。",
    },
    selector: {
    ...
    editor: {
      ...
      enabled: "启用",
      skillMd: "SKILL.md",
      templateTip: "请按预定义 Skills 的 SKILL.md 格式编写：YAML frontmatter 中填写 name 和 description，正文写使用场景、流程和输出要求。",
      readOnlyTip: "这是共享给你的 Skill，可查看内容；只有拥有者或管理员可以编辑保存。",
      invalidFrontmatter: "请保留以 --- 包裹的 YAML frontmatter",
      requiredFields: "name、description 和正文内容不能为空",
    },
    share: {
      title: "分享 Skill",
      action: "分享",
      spaceTab: "共享空间",
      userTab: "用户",
      sharedSpaces: "已分享的共享空间",
      sharedUsers: "已分享的用户",
      noUserShares: "暂无用户分享",
      userSearchPlaceholder: "搜索用户名",
      userShareSuccess: "已分享给用户",
      userShareFailed: "分享给用户失败",
      loadFailed: "加载分享列表失败",
  ...
  organization: {
    ...
    addMember: {
      ...
      modeTenant: "按空间",
      modeMember: "按成员",
      modeOrganization: "按组织",
      tip: "添加的用户将立即成为空间成员，可以访问空间内共享的知识库。",
      tipTenant: "共享空间的成员单位是空间：选定一个空间后，其下全部用户都将获得访问权限。下方搜索结果按空间去重。",
      tipMember: "可直接多选 IAM 同步人员；未首次登录的人员会先记录待授权，首次登录后自动加入。",
      tipOrganization: "从 IAM 组织树选择组织，展开时按需加载下一级；提交时添加所选组织直属人员。",
      searchUser: "选择用户",
      searchTenant: "选择空间",
      selectMembers: "选择成员",
      ...
      memberSearchPlaceholder: "搜索成员名称或账号，可留空直接选择",
      searchHint: "输入至少 2 个字符开始搜索",
      searchTenantHint: "输入至少 2 个字符开始搜索，按空间去重并自动过滤已加入的空间",
      memberSelectHint: "列表默认展示部分可添加成员，也可输入关键字筛选",
      organizationTreeHint: "组织树默认折叠；展开组织时加载下一级，勾选组织只添加该组织直属人员",
      organizationSelectedHint: "已选择 {orgCount} 个组织节点，将添加 {memberCount} 个空间成员",
      organizationUserCount: "{count} 人",
      organizationPreview: "将添加 {count} 个空间成员",
      noCandidates: "暂无可添加成员",
      noOrganizations: "暂无 IAM 组织数据",
      noOrganizationName: "未分配组织",
      pendingLoginTenant: "待首次登录后加入",
      duplicateTenantHint: "已自动合并 {count} 个同空间重复成员",
      selectRole: "分配角色",
      confirmBtn: "添加",
      confirmBatchBtn: "添加 {count} 个成员",
      success: "成员添加成功",
      batchSuccess: "已添加 {count} 个成员",
      batchFailed: "{count} 个成员添加失败",
      failed: "添加失败",
      roleHint: {
        viewer: "可查看和搜索",
        editor: "可编辑内容",
  ...
  preview: {
    ...
    safePreviewTitle: "已启用安全预览",
    safePreviewHint: "该文档较大或内部结构复杂，不会将原文件一次性载入浏览器。请使用分页解析内容查看，避免页面卡顿或内存溢出。",
    viewPagedContent: "查看分页解析内容",
    truncatedHint: "为保证页面流畅，原文件预览仅显示前 512 KB；完整内容可在分块视图中按页查看。",
    audioSafePreviewHint: "音频文件较大，已停止整文件载入以避免占用过多浏览器内存。",
  },
  commandPalette: {
  ...
  agentStream: {
    ...
    tools: {
      ...
      tableAnalysis: "表格分析",
      tableSchema: "表格结构",
      tableAnalysisDisplayIntent: "图表意图判断",
      databaseQuery: "数据库查询",
      dbCatalog: "数据库目录",
      dbSchema: "数据库结构",
      dbQuery: "数据源分析",
    ...
    ragPipeline: {
      ...
      retrievalSummary: "检索完成，已检索 {count} 份文档，耗时 {duration}",
      dataSourceRetrievalSummary: "检索完成，已检索 {count} 个数据源，耗时 {duration}",
      noRetrievalSummary: "检索完成，未检索文档，耗时 {duration}",
      noDataSourceRetrievalSummary: "检索完成，未检索数据源，耗时 {duration}",
  ...
  integrations: {
    ...
    api: {
      ...
      signedFlowDetail:
        "HMAC 密钥仅保存在茅台智汇与可信后端，切勿放入请求或下发给浏览器。请求头里传的是用该密钥签出的 JWT 字符串（每次签发或过期后会变），不是密钥本身。JWT 须包含 sub（外部用户 ID）、tenant_id、aud=weknora、exp（有效期不超过 24 小时）。",
      ...
      hmacSecret: "HMAC 密钥",
      hmacSecretDesc: "与茅台智汇保存的同一份密钥；仅用于后端签发 JWT，不要作为请求头发送。",
    ...
    chrome: {
      title: "知识管理助手",
      subtitle:
        "配合茅台智汇服务使用：在任意网页侧边栏提问、剪藏内容、Markdown 速记，将浏览中的知识沉淀到你的知识库。",
      ...
      steps: {
        ...
        port: {
          title: "桌面版配置固定端口（推荐）",
          desc: "使用茅台智汇桌面版时，在 API 信息中设置固定端口（如 37841），避免每次启动后地址变化导致插件断连。",
        },
        install: {
          title: "安装 Chrome 插件",
    ...
    claw: {
      title: "智汇技能",
      subtitle:
        "通过茅台智汇 REST API 导入文档并执行混合检索（向量 + 关键词）。适用于上传文件/URL/Markdown 到知识库、跨库检索与浏览知识内容。",
      ...
      ecosystemNote:
        "智汇技能托管于 ClawHub，完整 API 说明与版本历史请参见 ClawHub 页面。",
      installCta: "前往 ClawHub",
      installCtaHint: "安装智汇技能 · 将在新标签页打开",
      hubMeta: "ClawHub · 智汇技能 · MIT-0",
    },
  },
  imOverview: {
    menuTitle: "已接入的 IM",
  ...
  tenantMember: {
    ...
    errors: {
      usernameRequired: "请输入用户名",
      roleRequired: "请选择角色",
      userNotFound: "该用户名尚未注册，请先邀请对方注册账号。",
  ...
  tenantInvitation: {
    ...
    confirmInviteBody:
      "将向 {username} 发出加入邀请（角色：{role}）。TA 在站内接受后才会成为成员。",
    confirmSend: "发送",
    copyLink: "复制邀请链接",
    copied: "已复制到剪贴板",
    ...
    shareLink: {
      ...
      description:
        "生成一条多人可用的注册链接，发到群里就行；谁打开都能用自己的用户名注册并加入当前空间。链接 {days} 天后过期，或随时可在列表中撤销。",
      generate: "生成链接",
      resultTitle: "邀请链接已生成",
    ...
    revoke: {
      ...
      confirmTitle: "确认撤销邀请？",
      confirmBody:
        "撤销后，{username} 将无法再接受此邀请；如需再邀请请重新发出。",
      confirm: "撤销",
      success: "邀请已撤销。",
    },
    columns: {
