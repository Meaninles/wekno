export default {
  ...
  organization: {
    ...
    addMember: {
      ...
      tipMember: "可直接多选 IAM 同步人员；提交时会按人员对应空间加入，同一空间只添加一次。",
      tipOrganization: "从 IAM 组织树选择组织，父级、子级和叶子级都可选择；提交时会添加所选组织及其下级组织中的可用成员。",
      searchUser: "选择用户",
      searchTenant: "选择空间",
      selectMembers: "选择成员",
      ...
      organizationTreeHint: "组织树默认折叠；勾选任意层级会包含其下级组织成员",
