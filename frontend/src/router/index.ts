    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "chromeExtensionGuide",
          component: () => import("../custom/modules/chrome-extension/ChromeExtensionGuide.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
        {
        ...
        },
        {
          path: "data-sources",
          name: "dataSourceList",
          component: () => import("../custom/modules/dbanalytics/DataSourceList.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
        {
          path: "skills",
          name: "skillList",
          component: () => import("../custom/modules/skillhub/SkillList.vue"),
          meta: { requiresInit: true, requiresAuth: true }
        },
        {
