...
export interface DatabaseMetadataData {
    display_type: 'db_catalog' | 'db_schema';
    query?: string;
    count?: number;
    tables?: DatabaseMetadataTable[];
}

export interface StructuredAnalysisColumn {
    name: string;
    type?: string;
    semantic_type?: string;
}

export interface StructuredAnalysisChartSpec {
    eligible: boolean;
    id?: string;
    type?: 'bar' | 'line' | 'stacked_bar' | 'pie' | 'scatter' | 'histogram' | 'heatmap' | 'funnel' | 'dual_axis_combo' | 'area' | 'radar' | 'treemap' | 'boxplot' | string;
    default_type?: 'bar' | 'line' | 'stacked_bar' | 'pie' | 'scatter' | 'histogram' | 'heatmap' | 'funnel' | 'dual_axis_combo' | 'area' | 'radar' | 'treemap' | 'boxplot' | string;
    x?: string;
    y?: string[];
    group?: string;
    secondary_y?: string[];
    ...
    reason?: string;
    language?: string;
    labels_locale?: string;
    table_visible?: boolean;
    explicit_chart?: boolean;
    contract?: StructuredAnalysisChartContract;
    validation?: {
        status?: 'pass' | 'invalid' | 'not_requested' | string;
        issues?: string[];
    };
}

export interface StructuredAnalysisChartEncodingField {
    field?: string;
    role?: 'dimension' | 'time' | 'metric' | string;
    aggregate?: 'sum' | 'count' | 'avg' | 'min' | 'max' | 'none' | string;
}

export interface StructuredAnalysisChartContract {
    id?: string;
    type?: string;
    intent?: {
        task?: string;
    ...
    encoding?: {
        x?: StructuredAnalysisChartEncodingField;
        y?: StructuredAnalysisChartEncodingField;
        value?: StructuredAnalysisChartEncodingField | StructuredAnalysisChartEncodingField[];
        values?: StructuredAnalysisChartEncodingField[];
        secondary_value?: StructuredAnalysisChartEncodingField;
        series?: StructuredAnalysisChartEncodingField;
        stack?: StructuredAnalysisChartEncodingField;
        source?: StructuredAnalysisChartEncodingField;
        target?: StructuredAnalysisChartEncodingField;
        hierarchy?: StructuredAnalysisChartEncodingField[];
        [key: string]: StructuredAnalysisChartEncodingField | StructuredAnalysisChartEncodingField[] | undefined;
    };
    transform?: {
        group_by?: string[];
        aggregate?: string;
    ...
    evidence_scope?: {
        ...
        visualized_fields?: string[];
        non_visual_fields?: string[];
        description?: string;
    };
    display?: {
        title?: string;
...
export interface GeneralAgentArtifactFile {
    artifact_id: string;
    filename: string;
    file_type: string;
    file_size: number;
...
export interface GeneralAgentArtifactsData {
    display_type: 'general_agent_artifacts';
    artifacts: GeneralAgentArtifactFile[];
    summary?: string;
    notice?: string;
    artifact_original_count?: number;
    artifact_returned_count?: number;
    artifact_dropped_count?: number;
    artifact_returned_size?: number;
...
export interface StructuredAnalysisData {
    ...
    display_mode?: 'text_only' | 'chart_only' | 'chart_and_table' | 'table' | string;
    analysis_type: 'file' | 'database';
    source?: Record<string, any>;
    query?: string;
    columns: StructuredAnalysisColumn[];
    rows: Array<Record<string, any>>;
    row_count: number;
    chart_requested?: boolean;
    table_requested?: boolean;
    table_visible?: boolean;
    chart?: StructuredAnalysisChartSpec;
