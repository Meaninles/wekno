...
func (e *AgentEngine) runReActIteration(
	...
	*messagesPtr = e.manageContextWindow(ctx, *messagesPtr, round, currentTokens)
	...
	e.executeToolCalls(ctx, response, &step, state.CurrentRound, sessionID, assistantMessageID, query)
...
func (e *AgentEngine) emitDirectFinalAnswer(ctx context.Context, sessionID, content string) {
	e.eventBus.Emit(ctx, event.Event{
