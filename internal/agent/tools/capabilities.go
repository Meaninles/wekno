...
// DeriveKBFilterForAgent uses the enabled tools of the unified harness.
func DeriveKBFilterForAgent(_ string, allowedTools []string) KBFilter {
	return DeriveKBFilterFromTools(allowedTools)
}
...
// capability requirements of the configured tools.
