...
func (s *skillService) ListPreloadedSkills(ctx context.Context) ([]*skills.SkillMetadata, error) {
	...
	metadata = append(metadata, additionalSkillMetadata(ctx)...)

	return metadata, nil
}

// ListProfessionalSkills returns metadata for Claude SDK native skills.
func (s *skillService) ListProfessionalSkills(ctx context.Context) ([]*skills.SkillMetadata, error) {
	return professionalSkillMetadata(ctx), nil
}
