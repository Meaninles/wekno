...
const (
	defaultToolCallbackURL        = "http://runtime-entry:8080/api/v1/custom/agent-runtime/internal/tools/call"
	defaultArtifactUploadURL      = "http://runtime-entry:8080/api/v1/custom/agent-runtime/internal/artifacts/upload"
