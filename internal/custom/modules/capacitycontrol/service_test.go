...
func TestCompilePoolReportsEffectiveModuleGrants(t *testing.T) {
	...
	require.Equal(t, 1, row.Effective.WikiMapWorkShare)
	require.Equal(t, 1, row.Effective.WikiCommitWorkShare)
	require.Equal(t, 1, row.Effective.WikiMapProviderShare)
