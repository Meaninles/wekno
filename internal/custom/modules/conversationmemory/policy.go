...
- A conversation-only state or transformation task must use evidence_need "none". An ordinary knowledge question and the external portion of a mixed request still require the appropriate evidence_need.
