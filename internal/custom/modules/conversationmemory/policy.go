...
const (
	generationMarker          = "[WEKNORA_DIALOGUE_CONTINUITY_V7]"
	rewriteMarker             = "[WEKNORA_DIALOGUE_INTENT_V7]"
	turnSemanticMarker        = "[WEKNORA_CURRENT_TURN_SEMANTICS_V7]"
