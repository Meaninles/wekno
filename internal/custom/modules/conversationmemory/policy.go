...
const (
	generationMarker          = "[WEKNORA_DIALOGUE_CONTINUITY_V5]"
	rewriteMarker             = "[WEKNORA_DIALOGUE_INTENT_V5]"
	turnSemanticMarker        = "[WEKNORA_CURRENT_TURN_SEMANTICS_V5]"
