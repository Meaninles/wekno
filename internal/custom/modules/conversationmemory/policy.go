...
const (
	generationMarker          = "[WEKNORA_DIALOGUE_CONTINUITY_V6]"
	rewriteMarker             = "[WEKNORA_DIALOGUE_INTENT_V6]"
	turnSemanticMarker        = "[WEKNORA_CURRENT_TURN_SEMANTICS_V6]"
