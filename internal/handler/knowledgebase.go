...
// 优先）。任意一步失败都吞掉错误：creator_name 缺失只会影响
...
// pickUserDisplayName picks the field most users will recognise. Used by both
// KB and Agent list enrichment so the badge text stays consistent.
