...
func (h *OrganizationHandler) ListMembers(c *gin.Context) {
	...
	// plus the representative user (username/avatar). Only orgs
...
// by username, groups them by their TenantID, resolves the tenant's
...
// @Produce      json
// @Param        id     path   string  true   "组织ID"
// @Param        q      query  string  true   "搜索关键词（租户名或用户名）"
