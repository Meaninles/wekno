...
// Username is the user-facing identifier; the handler resolves it to a User row
// before delegating to the service. The optional Message is surfaced in the
// invitee's inbox.
...
// @Summary      发出租户邀请
// @Description  Owner 通过用户名邀请已注册用户加入当前租户；被邀请人需要在 /me/invitations 接受后才会成为成员。
// @Tags         租户邀请
// @Accept       json
// @Produce      json
// @Param        id       path  string                   true  "租户 ID"
