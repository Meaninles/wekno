...
const (
	...
	// KnowledgeFolderIDContextKey carries the validated management-only folder
	// placement for a knowledge create operation. It never participates in
	// parsing, indexing, or retrieval.
