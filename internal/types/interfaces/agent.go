...
// importing internal/agent/tools here, which would create a package cycle.
type AgentToolRegistry interface {
	GetFunctionDefinitions() []types.FunctionDefinition
	ExecuteTool(ctx context.Context, name string, args json.RawMessage) (*types.ToolResult, error)
...
type AgentService interface {
	...
	// permissions, retrieval, MCP approval and data-source tools without
