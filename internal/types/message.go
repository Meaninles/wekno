...
type Message struct {
	...
	Artifacts      []MessageArtifact `json:"artifacts,omitempty" gorm:"-"`
	ArtifactNotice string            `json:"artifact_notice,omitempty" gorm:"-"`
