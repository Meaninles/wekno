...
var (
	...
	PlaceholderDocumentTemplateContext = PromptPlaceholder{
		Name:        "document_template_context",
		Label:       "文档模板上下文",
		Description: "文档处理智能体的全部模板要求文件与参考模板文件，包含固定文件路径、用途和缺失时的兜底规则",
	}

	PlaceholderDocumentTemplateUsageRules = PromptPlaceholder{
		Name:        "document_template_usage_rules",
		Label:       "文档模板使用规则",
		Description: "说明模板要求文件、参考模板文件、用户要求与源文件之间的优先级和使用方式",
	}

	PlaceholderWordTemplateRequirement = PromptPlaceholder{
		Name:        "word_template_requirement",
		Label:       "Word模板要求",
		Description: "Word 文档的模板要求文件固定路径和摘要；未上传或已删除时显示缺失说明",
	}

	PlaceholderWordTemplateFiles = PromptPlaceholder{
		Name:        "word_template_files",
		Label:       "Word参考文档",
		Description: "Word 参考模板文件的固定路径列表；模板是软参考，不是填空模板",
	}

	PlaceholderExcelTemplateRequirement = PromptPlaceholder{
		Name:        "excel_template_requirement",
		Label:       "Excel模板要求",
		Description: "Excel 文档的模板要求文件固定路径和摘要；未上传或已删除时显示缺失说明",
	}

	PlaceholderExcelTemplateFiles = PromptPlaceholder{
		Name:        "excel_template_files",
		Label:       "Excel参考文档",
		Description: "Excel 参考模板文件的固定路径列表；模板是软参考，不是填空模板",
	}

	PlaceholderPDFTemplateRequirement = PromptPlaceholder{
		Name:        "pdf_template_requirement",
		Label:       "PDF模板要求",
		Description: "PDF 文档的模板要求文件固定路径和摘要；未上传或已删除时显示缺失说明",
	}

	PlaceholderPDFTemplateFiles = PromptPlaceholder{
		Name:        "pdf_template_files",
		Label:       "PDF参考文档",
		Description: "PDF 参考模板文件的固定路径列表；模板是软参考，不是填空模板",
	}

	PlaceholderPPTTemplateRequirement = PromptPlaceholder{
		Name:        "ppt_template_requirement",
		Label:       "PPT模板要求",
		Description: "PPT 文档的模板要求文件固定路径和摘要；未上传或已删除时显示缺失说明",
	}

	PlaceholderPPTTemplateFiles = PromptPlaceholder{
		Name:        "ppt_template_files",
		Label:       "PPT参考文档",
		Description: "PPT 参考模板文件的固定路径列表；模板是软参考，不是填空模板",
	}
)
...
func PlaceholdersByField(fieldType PromptFieldType) []PromptPlaceholder {
	...
	case PromptFieldAgentSystemPrompt:
		...
		return []PromptPlaceholder{
			...
			PlaceholderCurrentTime,
			PlaceholderLanguage,
			PlaceholderDocumentTemplateContext,
			PlaceholderDocumentTemplateUsageRules,
			PlaceholderWordTemplateRequirement,
			PlaceholderWordTemplateFiles,
			PlaceholderExcelTemplateRequirement,
			PlaceholderExcelTemplateFiles,
			PlaceholderPDFTemplateRequirement,
			PlaceholderPDFTemplateFiles,
			PlaceholderPPTTemplateRequirement,
			PlaceholderPPTTemplateFiles,
		}
