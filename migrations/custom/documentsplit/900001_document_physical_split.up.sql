...
CREATE TABLE IF NOT EXISTS custom_document_split_parts (
    id varchar(36) PRIMARY KEY,
    plan_id varchar(36) NOT NULL REFERENCES custom_document_split_plans(id) ON DELETE CASCADE,
    tenant_id bigint NOT NULL,
    knowledge_base_id varchar(36) NOT NULL,
    knowledge_id varchar(36) NOT NULL,
    processing_generation varchar(64) NOT NULL,
...
ALTER TABLE chunks ADD COLUMN IF NOT EXISTS processing_generation varchar(36) NOT NULL DEFAULT '';
ALTER TABLE chunks ADD COLUMN IF NOT EXISTS split_part_index integer NOT NULL DEFAULT -1;
ALTER TABLE chunks ADD COLUMN IF NOT EXISTS source_locator jsonb NULL;
ALTER TABLE chunks
