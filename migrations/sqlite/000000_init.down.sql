-- Reverse the consolidated Lite schema in dependency-safe order.
...
DROP TABLE IF EXISTS knowledge_fanout_completions;
...
DROP TABLE IF EXISTS custom_wiki_ingest_leases;
